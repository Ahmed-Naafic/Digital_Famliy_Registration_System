...
/// Death Registration Step 3: Document Upload
class DeathRegistrationStep3Page extends StatelessWidget {
  const DeathRegistrationStep3Page({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Please upload the required documents for death registration',
